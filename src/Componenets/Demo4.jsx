                                    ...
                                    <div className='container-fluid'>
                                        ...
                                        <div className='text-center '>
                                            ...
                                            <div className="row text-start ">
                                                ...
                                                <div className="history-container col-md-12 rounded-2 custom-scrollbar" style={{ whiteSpace: 'pre-wrap', outline: 'none', border: '1px solid #ddd', padding: '5px', maxHeight: '210px', overflowY: "auto", minHeight: "199px" }}>
