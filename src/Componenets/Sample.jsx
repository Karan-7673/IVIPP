...
const Navbar = ({ section1Ref }) => {
    ...
    const handleSpeechResponse = (text) => {
        ...
        // if (isActive === true) {
        //     // startListening();
        //     console.log("listening start bar start");
        // }
        ...
        const interval = setInterval(() => {
            ...
            if (index >= text.length) {
                ...
                // startListening();
                if (isActive) {
                    console.log("listening stop bar stop");
                }
            }
        }, 75);
    };
    ...
    const fetchGoogleSearchResults = async (query) => {
        try {
            ...
            if (data.items) {
                ...
                return []; // Ensure you return an empty array if no items
            }
        } catch (error) {
            console.error('Error fetching search results:', error);
                                    ...
                                    <div className='container-fluid'>
                                        ...
                                        <div className='text-center '>
                                            ...
                                            <div className="row text-start ">
                                                ...
                                                <div className="history-container col-md-12 rounded-2 custom-scrollbar" style={{ whiteSpace: 'pre-wrap', outline: 'none', border: '1px solid #ddd', padding: '5px', maxHeight: '200px', overflowY: "auto", minHeight: "199px" }}>
                                            ...
                                            <div className="d-flex justify-content-center ">
                                                {/* <button onClick={saveToFile}><FiFileText /></button> */}
